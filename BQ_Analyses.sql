CREATE OR REPLACE TABLE postgis.MA_Results AS (

SELECT * FROM `postgis.MA_State_BSL` as A
...
--ADD ALL THE FORMATING FIELDS THAT MA REQUESTED

ALTER TABLE postgis.MA_Results
...
;
UPDATE `postgis.MA_Results` SET Served25x3 = 'Yes' WHERE bsl_id25x3 IS NOT NULL; 
UPDATE `postgis.MA_Results` SET ServedWireline25x3 = 'Yes' WHERE bsl_idwire25x3 IS NOT NULL ;
UPDATE `postgis.MA_Results` SET ServedWireless25x3 = 'Yes' WHERE bsl_idwireless25x3 IS NOT NULL ;

UPDATE `postgis.MA_Results` SET Served100x20 = 'Yes' WHERE bsl_id100x20 IS NOT NULL ;
UPDATE `postgis.MA_Results` SET ServedWireline100x20 = 'Yes' WHERE bsl_idwire100x20 IS NOT NULL ;
UPDATE `postgis.MA_Results` SET ServedWireless100x20 = 'Yes' WHERE bsl_idwireless100x20 IS NOT NULL ;

UPDATE `postgis.MA_Results` SET Served100x100 = 'Yes' WHERE bsl_id100x100 IS NOT NULL ;
UPDATE `postgis.MA_Results` SET ServedWireline100x100 = 'Yes' WHERE bsl_idwire100x100 IS NOT NULL ;
UPDATE `postgis.MA_Results` SET ServedWireless100x100 = 'Yes' WHERE bsl_idwireless100x100 IS NOT NULL ;

UPDATE `postgis.MA_Results` SET Served1Gx1G = 'Yes' WHERE bsl_id1Gx1G IS NOT NULL ;
UPDATE `postgis.MA_Results` SET ServedWireline1Gx1G = 'Yes' WHERE bsl_idwire1Gx1G IS NOT NULL ;
UPDATE `postgis.MA_Results` SET ServedWireless1Gx1G = 'Yes' WHERE bsl_idwireless1Gx1G IS NOT NULL ;

--max down/up wireline
UPDATE `postgis.MA_Results` SET MaxDownWireline = maxwiredown  WHERE maxwireBSL IS NOT NULL ;
UPDATE `postgis.MA_Results` SET MaxUpWireline = maxwireup  WHERE maxwireBSL IS NOT NULL ;
--max down/up wireless
UPDATE `postgis.MA_Results` SET MaxDownWireless = maxwirelessdown  WHERE maxwirelessBSL IS NOT NULL ;
UPDATE `postgis.MA_Results` SET MaxUpWireless = maxwirelessup  WHERE maxwirelessBSL IS NOT NULL ;

--unique number of providers
UPDATE `postgis.MA_Results` SET NumProviders25x3 = uniq25x3  WHERE uniq25x3BSL IS NOT NULL ;
UPDATE `postgis.MA_Results` SET NumProviders100x20 = uniq100x20  WHERE uniq100x20BSL IS NOT NULL ;
UPDATE `postgis.MA_Results` SET NumProviders100x100 = uniq100x100  WHERE uniq100x100BSL IS NOT NULL ;
UPDATE `postgis.MA_Results` SET NumProviders1Gx1G = uniq1000x1000  WHERE uniq1Gx1GBSL IS NOT NULL ;